...
//   www.exahype.eu
// ========================
#ifndef PointsSol_CLASS_HEADER_
#define PointsSol_CLASS_HEADER_
...
class IVM::PointsSol : public exahype::plotters::ADERDG2UserDefined {
 public:
  /**
   * Constructor.
   * 
