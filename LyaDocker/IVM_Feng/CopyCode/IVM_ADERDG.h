#ifndef __IVM_ADERDG_CLASS_HEADER__
#define __IVM_ADERDG_CLASS_HEADER__
...
class IVM::IVM_ADERDG : public IVM::AbstractIVM_ADERDG {
  private:
    /**
     * Log device
     */
  ...
  public:
    // static constexpr double l_m = -2.0e12;
    // static constexpr double m_m = -2.0e12;
...
#endif // __IVM_ADERDG_CLASS_HEADER__